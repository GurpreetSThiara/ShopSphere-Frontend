...
export default function NavigationBar() {
  ...
  const getSuggestions = (input) => {
    ...
    const filteredSuggestions = suggestions.filter((suggestion) => {
      ...
      // Check if the suggestion contains the input in either the starting or middle position
      const startsWithFilter = lowercasedSuggestion.startsWith(lowercasedInput);
      const includesFilter = lowercasedSuggestion.includes(
        ` ${lowercasedInput}`
      );

      // Combine filters as needed (using OR logic)
      return startsWithFilter || includesFilter;
    });
  ...
  return (
    <div className="bg-white item-center flex flex-col">
      {/* Mobile menu */}
                  ...
                  {showSearch && (
                    <Autosuggest
                      ...
                      inputProps={{
                        ...
                        className:
                          "p-2 text-gray-400 border border-gray-300 rounded-md search-input",
                      }}
                    />
                  )}
                </div>
  ...
  inputProps={{
    ...
    style: {
      ...
      suggestionsContainer: {
        ...
        border: '1px solid #ccc',
        borderRadius: '4px',
        zIndex: '50', // Ensure the suggestions appear above other components
      },
    },
  }}
/> */}
