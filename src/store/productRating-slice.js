...
export const createRating = createAsyncThunk('ratings/createRating', async (resData, { rejectWithValue }) => {
  try {
...
export const getAllRatings = createAsyncThunk('ratings/getAllRatings', async (productId, { rejectWithValue }) => {
  try {
